  ...
  return (
    <div className="w-full relative" ref={dropdownRef}>
      ...
      <div
        ...
        className="border border-gray-300 hover:border-black rounded p-3.5 w-full text-left cursor-pointer"
      >
        {selectedProduct ? (
          selectedProduct
        ) : (
            ...
            <ul className="max-h-48 overflow-y-auto">
              {filteredProducts.length > 0 ? (
                filteredProducts.map((product, index) => (
                  <li
                    key={index}
                    onClick={() => handleProductSelect(product.label)}
                ...
                <li
                  ...
                  onClick={() => handleProductSelect(searchTerm)}
                >
                  {searchTerm}
                </li>
              )}
